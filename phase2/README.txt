...
Scoreboards" to go see a ranking of every highscore ever saved on your device in any of our three games. From the
...
for Blackjack, fewest guesses for Guess the Number, time taken for Cows and Bulls). So we have six scoreboards,
three that rank people with respect to score, and three that rank them with respect to other game statistics.

Note also that Guess the Number & Cows and Bulls track score in such a way that the smallest score is best.